# Milestones: Pocket Monsters White 2

This roadmap governs research, tooling, analysis, reconstruction, and preservation for `SakuraiTsubaki/PocketMonsters-White2-Decompilation`.
...
| Field | Current value |
| --- | --- |
| Target | Pocket Monsters White 2 |
...
Coordinate Generation V sequel research with Black 2 and compare against Black/White without treating them as layout-identical.
